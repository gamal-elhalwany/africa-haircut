        ...
        <div class="row">
            ...
            <div class="col-md-6  d-none d-md-block">
                <div class="about_img" style="overflow:hidden">
                    <img class="about_img_1" src="{{asset('Design/images/old_place.jpg')}}" alt="about-1">
                    <img class="about_img_2" src="{{asset('Design/images/old_place2.jpg')}}" alt="about-2">
                    <img class="about_img_3" src="{{asset('Design/images/new_place.jpg')}}" alt="about-3">
                </div>
            </div>
        </div>
    </div>
...
<section class="gallery-section" id="gallery">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 gallery-column">
                <div style="height: 230px">
                    <div class="gallery-img" style="background-image: url({{asset('Design/images/IMG_6654.jpg')}});"></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 gallery-column">
                <div style="height: 230px">
            ...
            <div class="col-lg-3 col-md-6 gallery-column">
                <div style="height: 230px">
                    <div class="gallery-img" style="background-image: url({{asset('Design/images/IMG_6662.jpg')}});"></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 gallery-column">
                <div style="height: 230px">
        ...
        <ul class="team_members row">
            <li class="col-lg-3 col-md-6 padd_col_res">
                <div class="team_member">
                    <img src="{{asset('Design/images/stuff1.jpg')}}" alt="Team Member" height="281px">
                </div>
            </li>
            <li class="col-lg-3 col-md-6 padd_col_res">
                <div class="team_member">
                    <img src="{{asset('Design/images/stuff-2.jpg')}}" alt="Team Member" height="281px">
                </div>
            </li>
            <li class="col-lg-3 col-md-6 padd_col_res">
                <div class="team_member">
                    <img src="{{asset('Design/images/stuff-3.jpg')}}" alt="Team Member" height="281px">
                </div>
            </li>
            <li class="col-lg-3 col-md-6 padd_col_res">
                <div class="team_member">
                    <img src="{{asset('Design/images/stuff-4.jpg')}}" alt="Team Member"height="281px">
                </div>
            </li>
        </ul>
    </div>
