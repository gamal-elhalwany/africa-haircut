...
@push('style')
    <link rel="stylesheet" href="{{asset(env('App_Design_Url').'/Design/css/salary/main.css')}}">
@endpush
                        ...
                        <table class="table">
                            ...
                            @foreach($SalaryData as $UserSalary)
                                <tr>
                                    ...
                                    <td>{{\Carbon\Carbon::parse($UserSalary->start_time)->format('h')}}</td>
                                    <td>{{\Carbon\Carbon::parse($UserSalary->end_time)->format('h')}}</td>
