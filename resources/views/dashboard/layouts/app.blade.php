            ...
            <div class="burger-menu">
                ...
                <ul>
                    ...
                    <a href="{{route('dashboard.chairs.index')}}">
                        ...
                        <li class="list-list-item">
                            <i class="ri-bar-chart-grouped-line"></i>  <span>الكراسي</span>
                        </li>
                    </a>
...
{{--                        <a href="{{route('dashboard.users.index')}}">--}}
{{--                            <li class="list-list-item">--}}
{{--                                <i class="ri-user-line"></i> المستخدمين--}}
{{--                            </li>--}}
{{--                        </a>--}}
...
{{--                    <a href="{{route('dashboard.branches.index')}}">--}}
{{--                            <li class="list-list-item">--}}
{{--                                <i class="ri-store-line"></i>  الفروع--}}
...
{{--                            <li class="list-list-item">--}}
{{--                                <i class="ri-equalizer-line"></i> الصلاحيات--}}
{{--                            </li>--}}
{{--                        </a>--}}
...
{{--                            <li class="list-list-item">--}}
{{--                                <i class="ri-bar-chart-grouped-line"></i>  الكراسي--}}
{{--                            </li>--}}
{{--                        </a>--}}
...
{{--                        <li class="list-list-item">--}}
{{--                            <i class="ri-printer-cloud-fill"></i>   الوظائف--}}
{{--                        </li>--}}
{{--                    </a>--}}
...
{{--                        <li class="list-list-item">--}}
{{--                            <i class="ri-product-hunt-line"></i>  الخدمات والمنتجات--}}
{{--                        </li>--}}
{{--                    </a>--}}
{{--                    <a href="{{route('dashboard.salary.index')}}">--}}

{{--                        <li class="list-list-item">--}}
{{--                            <i class="ri-product-hunt-line"></i>  المرتبات--}}
{{--                        </li>--}}
{{--                    </a>--}}
{{--                </ul>--}}
{{--            </div>--}}
